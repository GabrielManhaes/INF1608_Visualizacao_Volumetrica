...
__ss_int i_raio, i, res, k, j;
double resultado, res_2, res_1;
file *raw;
...
double simpson(lambda0 f, double a, double b) {
...
double opacidade(double s) {
    ...
    dt1 = (acesso(__vri__::dadosBinarios, __vri__::i_raio, __int(__math__::floor(s)), __vri__::k)/255.0);
    try {
        dt2 = (acesso(__vri__::dadosBinarios, __vri__::i_raio, (__int(__math__::floor(s))+__ss_int(1)), __vri__::k)/255.0);
    } catch (Exception *) {
        dt2 = dt1;
    }
    dt = lerp(dt1, dt2, 0.5);
...
double integralRenderizacaoVolumetrica(__ss_int s) {
    ...
    return simpsonAdaptativo(((lambda0)(funcaoRenderizacaoVolumetrica)), ((double)(__ss_int(0))), ((double)(s)), 0.001);
}
...
void __init() {
    ...
    while (__ne(__vri__::byte, const_7)) {
    ...
    while ((__vri__::k<__ss_int(99))) {
        ...
        while ((__vri__::i<__ss_int(128))) {
            ...
            res = __int(((__ss_int(255)*(__vri__::res_1+__vri__::res_2))/__ss_int(2)));
            __vri__::saidaPGM->append(__vri__::res);
        }
        k = (__vri__::k+__ss_int(1));
    }
    pgmwrite(__vri__::saidaPGM, __ss_int(128), __ss_int(99), default_0, __ss_int(255), default_1);
}
